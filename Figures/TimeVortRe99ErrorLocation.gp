...
set output "TimeVortRe99ErrorLocation.png"

#set ylabel "{/Italic=22 RMSE}"
#set xlabel "{/Italic=22 Number of sample points}"

set ylabel "{Relative Error of Vorticity %}"
...
p "TS_VortRe99_RelError.dat" u 1:2 w lp t '0.3m', "" u 1:3 w lp t '0.5m', "" u 1:4 w lp t '0.7m', "" u 1:5 w lp t '1.1m', "" u 1:6 w lp t '1.5m', "" u 1:7 w lp t '1.9m'