...
set output "VxRMSE_Samples_vs_Location.eps"
...
p "Velx_0.3mRelError.dat" u 1:4 every ::1::6 w lp lc -1 t '0.3m', \
"Velx_0.5mRelError.dat" u 1:4 every ::1::6  w lp lc -1 t "0.5m", \
